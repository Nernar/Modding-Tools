 ...
 */
Network.prototype.setUrl = if (url) {
 ...
 */
Network.prototype.setAddress = if (address) {
 ...
 */
Network.prototype.setCallback = if (callback) {
 ...
 */
Network.prototype.getStream = if () {
 ...
 */
Network.prototype.validateConnection = if () {
 ...
 */
Network.prototype.getConnection = if (force) {
 ...
 */
Network.prototype.hasConnection = if () {
 ...
 */
Network.prototype.disconnect = if () {
	let connection = this.getConnection();
 ...
 */
Network.prototype.getLength = if () {
 ...
 */
Network.Reader.prototype.getCharset = if () {
 ...
 */
Network.Reader.prototype.setCharset = if (charset) {
 ...
 */
Network.Reader.prototype.getStreamReader = if () {
 ...
 */
Network.Reader.prototype.inProcess = if () {
 ...
 */
Network.Reader.prototype.getCurrentlyReaded = if () {
 ...
 */
Network.Reader.prototype.getReadedCount = if () {
 ...
 */
Network.Reader.prototype.getResult = if () {
	let readed = this.getCurrentlyReaded();
 ...
 */
Network.Reader.prototype.read = if () {
 ...
 */
Network.Writer.prototype.getBufferSize = if () {
	return this.size || -1;
};
 ...
 */
Network.Writer.prototype.setBufferSize = if (size) {
 ...
 */
Network.Writer.prototype.getReadedCount = if () {
 ...
 */
Network.Writer.prototype.getStreamReader = if () {
	let stream = this.getStream();
	if (!stream) return null;
 ...
 */
Network.Writer.prototype.getOutputStream = if () {
 ...
 * @returns {boolean} in process
 */
Network.Writer.prototype.inProcess = if () {
	return !!this.processing;
};
 ...
 */
Network.Writer.prototype.download = if () {
 ...
 */
Network.Downloader = if (address, path) {
	address && this.setAddress(address);
 ...
 */
Network.Downloader.prototype.getFile = if () {
 ...
 */
Network.Downloader.prototype.setFile = if (file) {
 ...
 */
Network.Downloader.prototype.getPath = if () {
 ...
 * @param {string} path file path
 */
Network.Downloader.prototype.setPath = if (path) {
 ...
 */
Network.Downloader.prototype.getOutputStream = if () {
	let file = this.getFile();
	if (!file) return null;
	if (!file.exists()) {
 ...
 */
Network.handle = if (action, callback, connect) {
	if (!(action instanceof Function)) {
		throw new Error("Nothing to handle");
	}
	new java.lang.Thread(if () {
		try {
			action();
		} catch(e) {
			try {
 ...
 */
Network.lengthUrl = if (address, callback) {
	if (!Network.isOnline()) {
		if (callback && callback instanceof Object) {
 ...
 * @returns {boolean} has process started
 */
Network.readUrl = if (address, callback) {
	if (!Network.isOnline()) {
		if (callback && callback instanceof Object) {
			if (callback.hasOwnProperty("isNotConnected")) {
				callback.isNotConnected();
 ...
 * @returns {boolean} has process started
 */
Network.downloadUrl = if (address, path, callback) {
	if (!Network.isOnline()) {
		if (callback && callback instanceof Object) {
			if (callback.hasOwnProperty("isNotConnected")) {
				callback.isNotConnected();
