...
Window.prototype.width = Interface.Display.MATCH;
Window.prototype.height = Interface.Display.MATCH;
...
Window.prototype.setWidth = function(width) {
	if (typeof width != "undefined") {
		this.width = Interface.getX(width);
	}
	if (this.window) {
		this.update();
	}
...
Window.prototype.setHeight = function(height) {
	if (typeof height != "undefined") {
		this.height = Interface.getY(height);
	}
	if (this.window) {
		this.update();
	}
