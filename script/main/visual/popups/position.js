...
CoordsPopup.prototype.addGroup = function(name) {
	...
	views.titles[index] = new findAssertionPackage().android.widget.ToneTypingTextView(context);
...
CoordsPopup.prototype.getGroup = function(position) {
	...
	return this.groups[position] = {
		...
		addItem: function(current) {
			...
			item.views.mather = new findAssertionPackage().android.widget.ToneTypingTextView(context);
