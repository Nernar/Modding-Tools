...
const attachAdditionalInformation = function(control) {
	...
	if (session === undefined) MCSystem.throwException("ModdingTools: attachAdditionalInformation: Active session not found!");
...
const showModuleInfo = function(mod) {
	...
	builder.setNegativeButton(translate("Remove"), function() {
		confirm(translate("Warning!"), translate("Integration will be uninstalled with all content inside, please notice that's you're data may be deleted.") + " " +
