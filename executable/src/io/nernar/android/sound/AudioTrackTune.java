...
public class AudioTrackTune {
    ...
    public AudioTrackTune(AudioAttributes attributes, AudioFormat format, int bufferSizeInBytes, int mode, int sessionId) {
		mTrack = new AudioTrack(attributes, format,
								bufferSizeInBytes, mode, sessionId);
		mBufferSize = bufferSizeInBytes;
		mSampleRateInHz = 4000;
