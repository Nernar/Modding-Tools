...
ExplorerWindow.prototype.resetContent = function() {
	...
	views.info = new findEditorPackage().widget.ToneTypingTextView(context);
...
ExplorerWindow.Path.prototype.addPathText = function(text, file) {
	let path = new findEditorPackage().widget.ToneTypingTextView(context);
...
ExplorerWindow.Rename.prototype.reset = function() {
	...
	views.approve = new findEditorPackage().widget.ToneTypingTextView(context);
	...
	views.format = new findEditorPackage().widget.ToneTypingTextView(context);
...
ExplorerAdapter.prototype = new JavaAdapter(android.widget.BaseAdapter, android.widget.Adapter, {
	...
	makeItemLayout: function() {
		...
		let date = new findEditorPackage().widget.ToneTypingTextView(context);
		...
		let name = new findEditorPackage().widget.ToneTypingTextView(context);
		...
		let size = new findEditorPackage().widget.ToneTypingTextView(context);
