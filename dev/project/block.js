function BlockWorker(obj) {
	...
	this.loadProject = function(obj) {
		...
		obj.renderer && this.Renderer.setParams(obj.renderer);
		obj.collision && this.Collision.setParams(obj.collision);
	};
	this.Define = {
		params: {
			id: "customBlock",
	...
	this.Collision = {
		...
		Model: function() {
			...
			// Mirror and rotate
			this.mirrorBox = function(index, orientate) {
				var box = this.getBox(index);
				if (orientate == 0) {
					var x1 = box.x1, x2 = box.x2;
					box.x2 = 2 * box.x2 - x1;
